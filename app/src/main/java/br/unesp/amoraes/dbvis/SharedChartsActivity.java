...
public class SharedChartsActivity extends Activity implements IBasicChartActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_shared_charts);
	...
	private void getListOfPreviewsAndCharts() {
		...
		for(Integer k : Visualization.getInstance().getOtherUsersContents().getCharts().keySet()){
			UserChart uc = Visualization.getInstance().getOtherUsersContents().getCharts().get(k);
	...
	private void openChart(int selectedPosition) {
		...
		String timeFormat = getResources().getString(R.string.format_time);
		SimpleDateFormat timeFormatter = new SimpleDateFormat(timeFormat);
		String text = uc.getText()+" ("+uc.getDeviceName()+", "+timeFormatter.format(uc.getDate())+")";
